...
module.exports = {
  dev: {
    ...
    proxyTable: {
      ...
      '/finance/hzed/ams': {
        // target: 'http://10.10.30.151:8101', // 测试环境
        target: 'http://xinanhyj.hzed.com', // 测试环境(新安)
        // target: 'http://xinancl.hzed.com', // 测试环境(新安存量)
        // target: 'https://haoyijie.hzed.com/finance', // 预生产环境
        // target: 'http://10.10.20.143:8101', // 肖时俊
        // target: 'http://10.10.20.150:8101', // 邓镇浩
        // target: 'http://10.10.20.198:8101', // 刘文
        // target: 'http://10.10.20.144:8101', // 章瑞林
        changeOrigin: true,
        pathRewrite: {
          '^/finance/hzed/ams': '/finance/hzed/ams'
        }
      }
    },
